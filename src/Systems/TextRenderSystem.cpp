...
TextRenderSystem::TextRenderSystem(	sf::RenderWindow& window,Level::CompMap& components)
...
void TextRenderSystem::update(sf::Time deltaTime)
{
    for(auto it=entities.begin();it!=entities.end();it++)
    {
        ...
        TextComponent* tC=boost::polymorphic_downcast<TextComponent*>(components.at(Level::CompKey(*it, "Text")));
