...
PositionRelativeToComponent::PositionRelativeToComponent(int EID, int relativeTo)
:Component(EID), relativeTo(relativeTo)
{
}

PositionRelativeToComponent::PositionRelativeToComponent(rapidxml::xml_node<>* componentNode)
...
void PositionRelativeToComponent::read(rapidxml::xml_node<>* componentNode)
{
	if(componentNode->first_attribute("relativeTo")!=0)
		relativeTo=boost::lexical_cast<int>(componentNode->first_attribute("relativeTo")->value());
}
