...
void ParticleComponent::read(rapidxml::xml_node<>* componentNode)
{
	if(componentNode->first_attribute("minV")!=0)
		minV=boost::lexical_cast<double>(componentNode->first_attribute("minV")->value());
	if(componentNode->first_attribute("maxV")!=0)
		maxV=boost::lexical_cast<double>(componentNode->first_attribute("maxV")->value());
	if(componentNode->first_attribute("minAngle")!=0)
		minAngle=boost::lexical_cast<double>(componentNode->first_attribute("minAngle")->value());
	if(componentNode->first_attribute("maxAngle")!=0)
		maxAngle=boost::lexical_cast<double>(componentNode->first_attribute("maxAngle")->value());
	if(componentNode->first_attribute("minWidth")!=0)
		minWidth=boost::lexical_cast<double>(componentNode->first_attribute("minWidth")->value());
	if(componentNode->first_attribute("maxWidth")!=0)
		maxWidth=boost::lexical_cast<double>(componentNode->first_attribute("maxWidth")->value());
	if(componentNode->first_attribute("minHeight")!=0)
		minHeight=boost::lexical_cast<double>(componentNode->first_attribute("minHeight")->value());
	if(componentNode->first_attribute("maxHeight")!=0)
		maxHeight=boost::lexical_cast<double>(componentNode->first_attribute("maxHeight")->value());
	if(componentNode->first_attribute("minAngularV")!=0)
		minAngularV=boost::lexical_cast<double>(componentNode->first_attribute("minAngularV")->value());
	if(componentNode->first_attribute("maxAngularV")!=0)
		maxAngularV=boost::lexical_cast<double>(componentNode->first_attribute("maxAngularV")->value());
	if(componentNode->first_attribute("minGravity")!=0)
		minGravity=boost::lexical_cast<double>(componentNode->first_attribute("minGravity")->value());
	if(componentNode->first_attribute("maxGravity")!=0)
		maxGravity=boost::lexical_cast<double>(componentNode->first_attribute("maxGravity")->value());
	if(componentNode->first_attribute("minLifeTime")!=0)
		minLifeTime=boost::lexical_cast<double>(componentNode->first_attribute("minLifeTime")->value());
